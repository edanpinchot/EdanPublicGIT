...
public enum OATSDBType {
  ...
  /** Use reflection to create appropriate instance of DBMSImpl
   *
   * @param OATSDB_Type enum value specifies the DBMSImpl instance you want
  ...
  throws InstantiationException
  {
//    logger.info("Creating DBMSImpl implementation for {}", oatsdbType);                     //commented out all logger-related lines
...
//      logger.error(msg);
  ...
  /** Use reflection to create appropriate instance of TxMgrImpl
   *
   * @param OATSDB_Type enum value specifies the TxMgrImpl instance you want
   * @throws InstantiationException
   */
  @SuppressWarnings({ "unchecked", "rawtypes" })
  ...
  throws InstantiationException
  {
//    logger.info("Creating TxMgrImpl implementation for {}", oatsdbType);
