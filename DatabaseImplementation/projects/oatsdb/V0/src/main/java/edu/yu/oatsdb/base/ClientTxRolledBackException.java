 ...
 * has been rolled back unilaterally by the DBMSImpl e.g., when the client thread
 ...
 * by the DBMSImpl.  Also, the tx is marked as bring rolled back and is no longer
 * active.
 * 
 * @author Avraham Leff
 */
